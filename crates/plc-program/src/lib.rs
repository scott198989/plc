...
pub use instruction::{
    ...
    BoundInstructionFormal, BoundInstructionSignature, CALL_FB, CALL_FC, COMPARE_EQ, COMPARE_GE,
    COMPARE_GT, COMPARE_LE, COMPARE_LT, COMPARE_NE, COUNTER_DOWN, COUNTER_UP, COUNTER_UP_DOWN,
    DIVIDE, DisabledExecutionBehavior, FALLING_EDGE, FILL, FORMAL_CLOCK, FORMAL_COUNT_DOWN,
    FORMAL_COUNT_UP, FORMAL_CURRENT_VALUE, FORMAL_ELAPSED_TIME, FORMAL_ENABLE,
    FORMAL_ENABLE_OUTPUT, FORMAL_INPUT, FORMAL_LEFT, FORMAL_LIMIT_INPUT, FORMAL_LIMIT_OUTPUT,
    FORMAL_LOAD, FORMAL_MAXIMUM, FORMAL_MINIMUM, FORMAL_OUTPUT, FORMAL_PRESET_TIME,
    FORMAL_PRESET_VALUE, FORMAL_QD, FORMAL_QU, FORMAL_RESET, FORMAL_RIGHT, FORMAL_STATE,
    InstructionActivationPolicy, InstructionBindingError, InstructionCategory, InstructionCode,
    InstructionDefinition, InstructionFormalDefinition, InstructionFormalDirection,
    InstructionFormalId, InstructionLvalueConstraint, InstructionRegistry,
    InstructionRegistryError, InstructionTypeConstraint, JUMP, LIMIT, MODULO, MOVE, MULTIPLY,
    NO_OP, PHASE2_INSTRUCTION_REGISTRY_VERSION, PROBE, RETURN, RISING_EDGE, SUBTRACT,
    SideEffectClass, StateKind, StateRequirement, TIMER_OFF_DELAY, TIMER_ON_DELAY, TIMER_PULSE,
    TRACE_SAMPLE, phase2_instruction_registry,
};
