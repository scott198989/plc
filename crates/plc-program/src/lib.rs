...
pub use instruction::{
    ADD, BOOL_AND, BOOL_NOT, BOOL_OR, BOOL_XOR, BRANCH, BREAKPOINT_MARKER, CALL_FB, CALL_FC,
    COMPARE_EQ, COMPARE_GE, COMPARE_GT, COMPARE_LE, COMPARE_LT, COMPARE_NE, COUNTER_DOWN,
    COUNTER_UP, COUNTER_UP_DOWN, DIVIDE, FALLING_EDGE, InstructionCategory, InstructionCode,
    InstructionDefinition, InstructionRegistry, JUMP, MODULO, MOVE, MULTIPLY, NO_OP,
